...
void RespawnController::createPlayerRespawns() {
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 2; j++ ) {
            std::pair<int16_t, int16_t> position = {(WINDOW_WIDTH / 2)  - (SIZE_SPRITE_X) + (SIZE_SPRITE_X * i),
                                                    (WINDOW_HEIGTH * 4 / 5) - (SIZE_SPRITE_Y) + ((SIZE_SPRITE_Y / 2) * j)};
...
void RespawnController::createInfectedRespawns() {
    ...
    for (int i = 0; i < 7; i++) {
        for (int j = 0; j < 3; j++ ) {
            std::pair<int16_t, int16_t> position = {(WINDOW_WIDTH / 32) + ((SIZE_SPRITE_X / 2) * i),
                                                    ((WINDOW_HEIGTH * 4) / 5) - (SIZE_SPRITE_Y) + ((SIZE_SPRITE_Y / 2) * j)};
    ...
    for (int i = 0; i < 7; i++) {
        for (int j = 0; j < 3; j++ ) {
            std::pair<int16_t, int16_t> position = {(WINDOW_WIDTH * 3 / 4) + ((SIZE_SPRITE_X / 2) * i),
                                                    ((WINDOW_HEIGTH * 4) / 5) + ((SIZE_SPRITE_Y / 2) * j)};
            infectedAvailablePositions.push_back(position);
        }
    }
}
...
void RespawnController::createObstacleRespawns() {
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++ ) {
            std::pair<int16_t, int16_t> position = {(WINDOW_WIDTH / 4) + ((SIZE_SPRITE_X) * i),
                                                    ((WINDOW_HEIGTH * 4) / 5) + ((SIZE_SPRITE_Y) * j)};
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++ ) {
            std::pair<int16_t, int16_t> position = {(WINDOW_WIDTH * 3 / 5) + ((SIZE_SPRITE_X / 2) * i),
                                                    ((WINDOW_HEIGTH * 4) / 5) + ((SIZE_SPRITE_Y / 2) * j)};
            obstacleAvailablePositions.push_back(position);
        }
    }
