...
#define INITIAL_PLAYERS_AMOUNT 0
#define INITIAL_PLAYER_ID 0
#define INITIAL_INFECTED_ID 50
#define INITIAL_OBSTACLE_ID 64000
#define INITIAL_MAP_LIMIT_ID 40

#define OBSTACLE_TIRE 0x00
#define OBSTACLE_CRATER 0x01

#define CLOSE_DISTANCE 50
#define HOSTILE_RANGE 1000
#define REANIMATE_DISTANCE 80
#define ANGRY_WITCH_SPEED_INCREMENT 50
#define JUMPER_HABILITY_SPEED 10
#define SPEAR_HABILITY_SPEED 12
