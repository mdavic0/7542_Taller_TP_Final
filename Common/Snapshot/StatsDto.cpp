...
StatsDto::StatsDto(const int8_t& playerId, const int16_t& kills, const int32_t& rankingKills,
    const int16_t shots, const int32_t& rankingShots, const int8_t& minutes, const int8_t& seconds,
...
int8_t StatsDto::getMinutes() const {
    return minutes;
}

int8_t StatsDto::getSeconds() const {
    return seconds;
}
...
void StatsDto::setMinutes(const int8_t& inputMinutes) {
    minutes = inputMinutes;
}

void StatsDto::setSeconds(const int8_t& inputSeconds) {
