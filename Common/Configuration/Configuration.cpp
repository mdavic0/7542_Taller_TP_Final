...
double CF::idf_scope = CF::file["idf_scope"].as<double>();
...
double CF::p90_scope = CF::file["p90_scope"].as<double>();
...
double CF::scout_scope = CF::file["scout_scope"].as<double>();
double CF::scout_damage_decrease_by_enemy = CF::file["scout_damage_decrease_by_enemy"].as<double>();
